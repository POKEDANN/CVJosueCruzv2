        ...
        setUpScriptBody: function (element, settings) {
            ...
            if(settings.sidebar.visible == true){
                ...
                if(settings.sidebar.searchBox.visible == true || settings.sidebar.searchBox.search == true){
                    sidebarBody.append("<div class='ct-googleMap--searchContainer'>"+"<input type='text' class='ct-googleMap--search' id='searchGmaps' placeholder='Buscar por ciudad'>"+"</div>");
        ...
        createMarkers: function(map, searchBox, markerTable, settings){
            ...
            if(settings.infoBubble.visible == true) {
                var infoBubble = new InfoBubble({
                    ...
                    "<span><strong>Tel: </strong>"+markerTable.telefono+"</span>"+
                    "<span><strong>Horario: </strong>"+markerTable.horario+"</span>"+
                    "<span>"+markerTable.encargado+"</span>"+
                    "<a href='mailto:"+markerTable.correo+"'>"+markerTable.correo+"</a><br>"+
                ...
                google.maps.event.addListener(marker, "click", function () {
                    ...
                    map.setZoom(15); //zoom en el marcador
                });
                if(settings.infoBubble.getDirectionsButton == true){
